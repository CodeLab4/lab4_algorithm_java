...
public class NewsClustering_mungnam {

    /**
     * 예전에 한 번 풀어봤던 문제였는데 따로 코드를 보관하지 않은 문제였다.
     * 풀어봤던 문제임에도 내가 제출한 코드를 봤는데 한 눈에 들어오지가 않았다.
     * 그 동안은 새로운 문제들을 풀기에 급급했는데, 이 문제를 풀면서 생각이
     * 조금 바뀌었다. 앞으로는 풀어본 문제라도 시간이 좀 지난 뒤에 다시 한번
     * 풀어봐야겠다고 다짐했다.
     */
